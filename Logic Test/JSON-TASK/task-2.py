...
for purchase in purchases:
    # Check if the customer name is "Annis"
    if purchase['customer']['name'] == 'Annis':
        # Calculate the total price of items for this purchase
        total_price = sum(item['qty'] * item['price'] for item in purchase['items'])
